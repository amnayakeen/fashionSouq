  ...
  <body>
		...
		<div class = "row">
			<div class = "col-md-6">
				<div class="card custom-card custom-text">
					<a href = "abaya.php"><img src="abaya.png" class="custom-img" alt="Unavailable"></a>
						<div class="card-body">
			...
			<div class = "col-md-6">
				<div class="card custom-card custom-text">
					<a href = "shalwar.php"><img src="shalwar.jpg" class="custom-img" alt="Unavailable"></a>
						<div class="card-body">
	...
	<a class = "custom-product" href = "shalwar.php"><h2 class = "custom-text">SHALWARS</h2></a>
		<div class = "row">
			<div class = "col-md-4">
				<div class="card custom-card custom-text">
					<a href = "s1.jpg"><img src="s1.jpg" class="custom-img" alt="COTTON SHALWAR"></a>
						<div class="card-body">
			...
			<div class = "col-md-4">
				<div class="card custom-card custom-text">
					<a href = "s5.jpg"><img src="s5.jpg" class="custom-img" alt="COTTON SHALWAR"></a>
						<div class="card-body">
							<h6 class="card-title">COTTON SHALWAR</h6>
		...
		<div class = "row">
			<div class = "col-md-4">
				<div class="card custom-card custom-text">
					<a href = "s4.jpg"><img src="s4.jpg" class="custom-img" alt="COTTON PRINTED SHALWAR"></a>
						<div class="card-body">
